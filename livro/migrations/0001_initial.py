# Generated by Django 4.0.3 on 2022-06-19 15:51
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('img', models.ImageField(blank=True, default='capa_livro/img.jpg', null=True, upload_to='capa_livro')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('data_emprestimo', models.DateTimeField(default=datetime.datetime(2022, 6, 19, 12, 51, 24, 183443))),
                ('data_devolucao', models.DateTimeField(blank=True, null=True)),
                ('avaliacao', models.CharField(choices=[('P', 'Péssimo'), ('R', 'Ruim'), ('B', 'Bom'), ('O', 'Otimo')], max_length=1, null=True)),
                ('livro', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='livro.livros')),
